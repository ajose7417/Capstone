...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Live<span><img class="responsive" src="LiveCAN/image/leaf.png" width="25" height="25"></span>CAN</b></a>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==1) 
                {
                    ...
                    $result = mysqli_query($con,"SELECT attempts FROM user where email= '$email'") or die('Error');
                    $row = mysqli_fetch_array($result);
                    $attempts = $row['attempts'];

                    if($rowcount == 0){
                        if($attempts>=3){
                            echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$title.'</center></td><td><center>'.$total.'</center></td><td><center>'.$sahi*$total.'</center></td><td><center><b><a href="payment.php" class="btn sub1" style="color:black;margin:0px;background:#1de9b6"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Pay Now</b></span></a></b></center></td></tr>';
                        }
                        else{
